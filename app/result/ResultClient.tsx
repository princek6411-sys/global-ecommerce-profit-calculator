...
type PublicResult = { productName?: string; currency: CurrencyCode; profit: number; margin: number; roi: number; score: number; platform: string; verdict: string; bestPlatform?: string };
