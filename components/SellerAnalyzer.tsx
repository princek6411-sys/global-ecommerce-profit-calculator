    ...
    <div className="card panel">
      ...
      {analysis && <>
        ...
        <div className="feature-grid" style={{ marginTop: 12 }}>
          ...
          <div className="card feature"><span className="feature-number">02</span><h3>Settlement check</h3><p>Expected payout {money(analysis.totals.expectedPayout)} vs actual payout {money(analysis.totals.actualPayout)}. Difference {money(analysis.totals.settlementDifference)}. Unexplained differences are not assigned to a made-up category.</p></div>
        </div>
